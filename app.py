...
# ============================================================
# RESPONSIVE WELCOME / ACCESS CARD
# Keeps Sign In, Register and Guest Access inside the
# "Welcome to CareerLens AI" card on all screen sizes.
# ============================================================
st.markdown("""
<style>
/* Access buttons: desktop/tablet/mobile */
.welcome-access-card {
    width: 100%;
    max-width: 560px;
    margin: 0 auto;
...
.welcome-access-card .access-actions {
    display: grid;
...
.welcome-access-card .access-actions button {
    width: 100%;
    min-height: 46px;
    border-radius: 12px;
    font-weight: 800;
