...
UI Version 1: white navigation + blue gradient color system + Plus Jakarta Sans / Inter typography.
"""
...
.material-symbols-outlined{
  ...
  vertical-align:middle;
    ...
    @import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&family=Plus+Jakarta+Sans:wght@400;500;600;700;800;900&display=swap');
    ...
    *{ box-sizing: border-box; }
    ...
    p, span, label, div, input, textarea, button, select, option { font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; }
    h1, h2, h3, h4, h5, h6, .brand, .landing-brand, .cl-brand-wordmark, .hero-title, .landing-title, .header-title { font-family: 'Plus Jakarta Sans', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif !important; }
    ...
    .landing-frame:after { content:""; position:absolute;width:240px;height:240px;left:-150px;bottom:-150px;border-radius:50%;background:rgba(37,99,235,.08); }
    ...
    /* White sidebar */
    [data-testid="stSidebar"],[data-testid="stSidebar"]>div:first-child{background:#FFFFFF!important;border-right-color:#174A52!important}
...
/* ============================================================
   CAREERLENS UI V1 — BLUE GRADIENT + WHITE NAVIGATION
   UI-only override: preserves all application logic.
   ============================================================ */
:root{
  --cl-blue-50:#eff6ff;
  --cl-blue-100:#dbeafe;
  ...
  --cl-line:#e2e8f0;
  --cl-white:#ffffff;
  --cl-blue-gradient:linear-gradient(135deg,#2563eb 0%,#4f46e5 55%,#7c3aed 100%);
}

/* Global typography: Plus Jakarta Sans for hierarchy, Inter for readable UI text. */
html, body, .stApp, [data-testid="stAppViewContainer"]{
  font-family:'Inter',-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif !important;
  color:var(--cl-ink) !important;
}
h1,h2,h3,h4,h5,h6,.brand,.landing-brand,.cl-brand-wordmark,.hero-title,.landing-title,.header-title{
  font-family:'Plus Jakarta Sans',-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif !important;
}
.stButton>button,.stDownloadButton>button,.stFormSubmitButton>button,input,textarea,[data-baseweb="select"],button{
  font-family:'Inter',-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif !important;
}

/* Main page: clean white/light-blue canvas, no teal wash. */
.stApp{
  background:
    radial-gradient(circle at 92% 4%,rgba(59,130,246,.08),transparent 30%),
    radial-gradient(circle at 8% 92%,rgba(79,70,229,.045),transparent 28%),
...
[data-testid="stSidebar"]{
  ...
  border-right:1px solid #e2e8f0 !important;
  color:var(--cl-ink) !important;
  box-shadow:6px 0 24px rgba(15,23,42,.035) !important;
}
...
/* Sidebar buttons: white when inactive, blue gradient when selected. */
...
section[data-testid="stSidebar"] .stButton>button[kind="primary"]{
  background:var(--cl-blue-gradient) !important;
  color:#ffffff !important;
  border:1px solid transparent !important;
...
/* General buttons: blue brand action, no teal/green styling. */
.stButton>button,
...
/* Secondary buttons remain white instead of teal/gray filled controls. */
.stButton>button[kind="secondary"],
.stDownloadButton>button[kind="secondary"]{
  background:#ffffff !important;
  color:#334155 !important;
...
/* Inputs/selects: white surface + blue focus ring. */
.stTextInput input,.stTextArea textarea,[data-baseweb="select"]{
  background:#ffffff !important;
  color:#0f172a !important;
...
/* Progress / active indicators use the same blue gradient. */
.stProgress>div>div>div{
  background:var(--cl-blue-gradient) !important;
}
.cl-active-nav,.active-nav,.sidebar-active{
  background:var(--cl-blue-gradient) !important;
  color:#ffffff !important;
}

/* Remove the remaining teal/cyan decorative wash from the landing frame. */
.landing-frame:after{
  background:rgba(37,99,235,.07) !important;
}

/* Accessibility: blue focus instead of purple/teal. */
.stButton>button:focus-visible,.stDownloadButton>button:focus-visible,
.stTextInput input:focus-visible,.stTextArea textarea:focus-visible,
[data-baseweb="select"]:focus-within,[data-testid="stFileUploader"]:focus-within{
...
def build_resume_pdf(data: Dict, template: str) -> bytes:
    ...
    template_config = {
        ...
        "Compact": {"accent": "#2563eb", "title": 20, "align": TA_LEFT, "line": True},
    ...
    st.markdown(
        ...
        <div class="sidebar-brand-box">
            ...
            <div>
                ...
                <div style="font-size:.68rem;color:#64748B;font-weight:700;">Career Intelligence, Reimagined.</div>
            </div>
        </div>
        """,
        unsafe_allow_html=True,
...
if st.session_state.active_workspace == "Job Seeker Workspace":
    ...
    # 8. RESUME BUILDER
        ...
        preview_config = {
            ...
            "Compact": {"accent": "#2563eb", "bg": "#f8fbff", "heading": "#1d4ed8", "border": "#dbeafe", "font": "Inter", "radius": "10px", "header_align": "left"},
