...
if not st.session_state.is_logged_in:
    ...
    # Native Streamlit landing UI: no raw HTML is used here.
    st.markdown("## ✦ CareerLens **AI**")
    st.caption("AI POWERED CAREER PLATFORM")
    st.markdown("# Understand Your Career.\n## Build Your :blue[Future].")
    st.write("Get personalized insights, intelligent recommendations, and enterprise screening tools all in one unified ecosystem.")

    f1, f2, f3 = st.columns(3, gap="medium")
    with f1:
        st.markdown("### ✦ AI-Powered Insights")
        st.caption("Smarter career decisions")
    with f2:
        st.markdown("### ◎ Personalized Roadmaps")
        st.caption("Your goals, our guidance")
    with f3:
        st.markdown("### ♢ Trusted & Secure")
        st.caption("Your data stays safe")

    st.divider()
    st.markdown("### ✦ Welcome to CareerLens AI")
    st.write("Sign in, create an account, or explore instantly as a guest.")
