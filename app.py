...
if not st.session_state.is_logged_in:
    # ------------------------------------------------------------
    # Access actions are handled through query parameters so the
    # three controls can live INSIDE the HTML welcome card.
    # This avoids Streamlit widget blocks being rendered below it.
    # ------------------------------------------------------------
    _access_action = str(st.query_params.get("access", "") or "").strip().lower()

    if _access_action:
        # Remove the action before opening the dialog/rerunning so
        # browser refresh does not repeat the action.
        try:
    ...
    st.markdown(
        ...
        <div class="hero-shell">
            ...
            <div>
              ...
              <div class="feature-list">
                <div class="feature-item">
                  ...
                  <div><b>AI-Powered Insights</b><span>Smarter career decisions</span></div>
                </div>
                <div class="feature-item">
                  <div class="feature-icon">◎</div>
                  <div><b>Personalized Roadmaps</b><span>Your goals, our guidance</span></div>
                </div>
                <div class="feature-item">
                  <div class="feature-icon">♢</div>
                  <div><b>Trusted &amp; Secure</b><span>Your data stays safe</span></div>
                </div>
              </div>
            </div>
            ...
            <div>
              <div class="access-card">
                ...
                <div class="welcome-access-actions">
                  <a class="welcome-btn welcome-btn-primary" href="?access=signin">🔐 Sign In</a>
                  <a class="welcome-btn welcome-btn-secondary" href="?access=register">✨ Register / Create Account</a>
                  <div class="welcome-or">— OR —</div>
                  <a class="welcome-btn welcome-btn-secondary" href="?access=guest">🚀 Explore as Guest</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="hero-stats">
            ...
            <div class="hero-stat">
              <div class="hero-stat-icon">★</div>
              <div><b>95%</b><span>Match Precision</span></div>
            </div>
            <div class="hero-stat">
              <div class="hero-stat-icon">✦</div>
              <div><b>AI Driven</b><span>Fast Execution</span></div>
            </div>
          </div>
        </div>
        """,
