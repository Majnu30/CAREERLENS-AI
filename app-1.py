...
st.markdown(
    ...
    <style>
/* ============================================================
   CAREERLENS AI — GOAL 1 VISUAL SYSTEM
   Blue Gradient + White Sidebar + White Cards
...
:root {
  ...
  --cl-soft: #f8fafc;
  --cl-white: #ffffff;
  --cl-gradient: linear-gradient(135deg, #1d4ed8 0%, #2563eb 52%, #3b82f6 100%);
  --cl-gradient-hover: linear-gradient(135deg, #1e40af 0%, #1d4ed8 52%, #2563eb 100%);
  --cl-shadow-sm: 0 2px 8px rgba(15, 23, 42, 0.05);
  --cl-shadow-md: 0 8px 24px rgba(15, 23, 42, 0.09);
  --cl-shadow-lg: 0 16px 40px rgba(15, 23, 42, 0.12);
}
...
html, body, .stApp {
  ...
  background:
    radial-gradient(circle at 90% 0%, rgba(59,130,246,.10), transparent 32%),
    linear-gradient(180deg, #f8fbff 0%, #f1f5f9 100%) !important;
  -webkit-font-smoothing: antialiased;
}

p, span, label, input, textarea, button, select, option {
  font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif !important;
}
...
section[data-testid="stSidebar"] {
  border-right: 1px solid var(--cl-line) !important;
...
/* Sidebar navigation: white by default, blue gradient only for active/primary state */
...
section[data-testid="stSidebar"] .stButton > button[kind="primary"]:hover {
  background: var(--cl-gradient-hover) !important;
  color: #ffffff !important;
...
/* ============================================================
   BUTTONS — BLUE GRADIENT, NEVER TEAL/PURPLE
   ============================================================ */
...
button[data-testid="baseButton-primary"]:focus-visible {
  outline: 3px solid rgba(59,130,246,.25) !important;
...
.stTextArea textarea:focus {
  border-color: var(--cl-blue-2) !important;
...
.tag-purple {
  /* Keep legacy class visually inside the blue system */
  background: #eff6ff !important;
  color: #1d4ed8 !important;
  border: 1px solid #dbeafe !important;
}
...
/* ============================================================
   PROGRESS / CHECKBOX / RADIO / SLIDER ACCENTS
   ============================================================ */
...
input[type="radio"]:checked {
  accent-color: var(--cl-blue-2) !important;
}
